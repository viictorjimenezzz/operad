...
export const Generation = z.object({
  ...
  selected_lineage_id: z.string().nullable().optional(),
  individuals: z.array(z.record(z.unknown())).optional(),
...
export const RunSummary = z.object({
  ...
  has_graph: z.boolean(),
  graph_json: z.record(z.unknown()).nullable().optional(),
...
export const Manifest = z.object({
  ...
  cassetteStale: z.boolean().optional().default(false),
